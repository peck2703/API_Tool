...
/*               Folder Builder
 * 
 *  Generates a user-defined folder structure, in order to 
 *  keep the project organized.
 * 
 *  Look in the Menu Bar and select Assets > Create > Folders
 *  
 *                  ...IMPORTANT NOTE...
 *                  
 *  This script MUST be in an Editor folder in order to execute.
 * 
 */
...
public class FolderBuilder : EditorWindow {
	...
	[MenuItem("Assets/Create/Folders", false, 0)]
	static void createWindow()
	{
		FolderBuilder window = (FolderBuilder)EditorWindow.GetWindow(typeof(FolderBuilder));
